...
BY INSTALLING, DOWNLOADING, ACCESSING, OR USING THIS SOFTWARE, YOU AGREE TO BE BOUND BY THE TERMS OF THIS LICENSE AGREEMENT.
...
- **“Software”** means all binaries, executables, agents, container images, documentation, updates, and related materials distributed by Burnside Project LLC.
- **“Community Edition”** means the free version provided under Section 2.
- **“Enterprise Edition”** means the paid version provided under Section 3.
- **“Licensor”** means Burnside Project LLC.
- **“User”** or **“You”** means any individual or entity using the Software.

---

## SECTION 2 — COMMUNITY LICENSE (FREE USE)
...
- Access or request source code
- Modify the Software
- Redistribute the Software
- Sell or sublicense the Software
- Offer it as a hosted or managed service
- Embed it into a paid commercial product
- Reverse engineer, decompile, or disassemble
- Circumvent licensing or feature controls
...
## SECTION 3 — ENTERPRISE LICENSE

### 3.1 Commercial License Required
...
**Contact:** licensing@burnsideproject.ai

### 3.2 Enterprise Rights
...
## SECTION 4 — TRIAL-TO-PAID CONVERSION

### 4.1 Trial Period

If the Software includes Enterprise features enabled on a trial basis, such features are licensed for a limited evaluation period defined within the Software.
...
Failure to do so constitutes unlicensed commercial use.

### 4.3 Audit Rights

Licensor reserves the right to audit usage upon reasonable notice to ensure compliance.

---

## SECTION 5 — INTELLECTUAL PROPERTY

All rights, title, and interest in and to the Software remain exclusively with Burnside Project LLC.

No rights are granted by implication, estoppel, or otherwise beyond those expressly stated.

**Feedback** provided via GitHub issues or other channels may be used by Licensor without obligation or compensation.

---

## SECTION 6 — DATA & AI DISCLAIMER
...
This Agreement shall be governed by the laws of the State of Washington, USA, without regard to conflict of law principles.

Any disputes shall be resolved in Washington State courts.

---

## SECTION 10 — INVESTOR PROTECTION CLAUSE

The Software is proprietary technology forming part of Licensor’s core intellectual property portfolio.
...
This document constitutes the entire agreement for Community usage.

Enterprise customers are governed exclusively by their signed agreement.
